...
namespace project4 {
    ...
    public partial class project1DataSet3 : global::System.Data.DataSet {
        ...
        public partial class NguoiDungDataTable : global::System.Data.TypedTableBase<NguoiDungRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public NguoiDungRow AddNguoiDungRow(string TenDangNhap, string MatKhau, string TenNhanVien) {
...
namespace project4.project1DataSet3TableAdapters {
    ...
    public partial class NguoiDungTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[NguoiDung] WHERE (([TenDangNhap] = @Original_TenDangNhap) AND ((@IsNull_MatKhau = 1 AND [MatKhau] IS NULL) OR ([MatKhau] = @Original_MatKhau)) AND ((@IsNull_TenNhanVien = 1 AND [TenNhanVien] IS NULL) OR ([TenNhanVien] = @Original_TenNhanVien)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[NguoiDung] ([TenDangNhap], [MatKhau], [TenNhanVien]) VALUES (@" +
                "TenDangNhap, @MatKhau, @TenNhanVien);\r\nSELECT TenDangNhap, MatKhau, TenNhanVien " +
                "FROM NguoiDung WHERE (TenDangNhap = @TenDangNhap)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NguoiDung] SET [TenDangNhap] = @TenDangNhap, [MatKhau] = @MatKhau, [TenNhanVien] = @TenNhanVien WHERE (([TenDangNhap] = @Original_TenDangNhap) AND ((@IsNull_MatKhau = 1 AND [MatKhau] IS NULL) OR ([MatKhau] = @Original_MatKhau)) AND ((@IsNull_TenNhanVien = 1 AND [TenNhanVien] IS NULL) OR ([TenNhanVien] = @Original_TenNhanVien)));
SELECT TenDangNhap, MatKhau, TenNhanVien FROM NguoiDung WHERE (TenDangNhap = @TenDangNhap)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT TenDangNhap, MatKhau, TenNhanVien FROM dbo.NguoiDung";
        ...
        public virtual int Fill(project1DataSet3.NguoiDungDataTable dataTable) {
        ...
        public virtual project1DataSet3.NguoiDungDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            project1DataSet3.NguoiDungDataTable dataTable = new project1DataSet3.NguoiDungDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(project1DataSet3.NguoiDungDataTable dataTable) {
        ...
        public virtual int Delete(string Original_TenDangNhap, string Original_MatKhau, string Original_TenNhanVien) {
        ...
        public virtual int Insert(string TenDangNhap, string MatKhau, string TenNhanVien) {
            if ((TenDangNhap == null)) {
        ...
        public virtual int Update(string TenDangNhap, string MatKhau, string TenNhanVien, string Original_TenDangNhap, string Original_MatKhau, string Original_TenNhanVien) {
            if ((TenDangNhap == null)) {
                throw new global::System.ArgumentNullException("TenDangNhap");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string MatKhau, string TenNhanVien, string Original_TenDangNhap, string Original_MatKhau, string Original_TenNhanVien) {
            return this.Update(Original_TenDangNhap, MatKhau, TenNhanVien, Original_TenDangNhap, Original_MatKhau, Original_TenNhanVien);
        }
    }
